...
public class DataUtils {
  ...
  private static void insertData(Session session, String devicePath, int sensorNum, int dataNum)
  ...
  public static void addData(String devicePath, int sensorNum, int dataNum)
      throws IoTDBConnectionException, StatementExecutionException {
