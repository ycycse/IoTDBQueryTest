...
public class DeserializationTest {
  static int[] dataNums =
      new int[] {
        1, 1000, 10000, 100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, 900000,
        1000000
      };
  ...
  private static void testTimeForOld(String sql) {
    ...
    try (Session session = new Session("127.0.0.1", 6667, "root", "root")) {
      ...
      session.open(false);
      for (int i = 0; i < 120; i++) {
        OldSessionDataSet oldSessionDataSet = session.OldexecuteQueryStatement(sql, 500000);
